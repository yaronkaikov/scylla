    ...
    return do_with_cql_env_thread([] (cql_test_env& env) {
        ...
        auto check = [&] (const clustering_key& ck) {
            ...
            auto reader = make_combined_reader(schema, permit,
                    make_flat_mutation_reader_from_mutations_v2(schema, permit, generated_mutations, query::full_partition_range),
                    make_flat_mutation_reader_from_fragments(schema, permit, std::move(fragments)));
