...
/\ nrUpdates' = nrUpdates + 1
/\ nrUpdates < MaxNrUpdates
/\ UNCHANGED <<good, senderVars, receiverToSender, senderToReceiver, receiverHasCommit, receiverCurrentDict, receiverCommittedDict, receiverProtocolEpoch>>
...
\/ /\ receiverHasCommit
   ...
   /\ UNCHANGED <<nrUpdates, good, senderVars, senderToReceiver, receiverProtocolEpoch, receiverDicts>>
\/ /\ receiverHasUpdate /\ ~receiverHasCommit
   /\ receiverHasUpdate' = FALSE
...
\/ /\ msg[1] = "UPDATE"
   ...
   /\ UNCHANGED <<nrUpdates, good, receiverHasUpdate, receiverCurrentDict, receiverRecentDict>>
\/ /\ msg[1] = "COMMIT"
...
\* Last modified Wed May 22 15:00:30 CEST 2024 by michal
