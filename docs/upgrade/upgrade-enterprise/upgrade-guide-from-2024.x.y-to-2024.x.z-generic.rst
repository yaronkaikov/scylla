...
.. |SRC_VERSION| replace:: 2024.x.y
.. |NEW_VERSION| replace:: 2024.x.z

.. |MINOR_VERSION| replace:: 2024.x
...
.. caution:: 
    ...
    the next node before validating that the node that you upgraded is up 
    and running the new version.
...
.. caution:: 
    ...
    Apply the above procedure **serially** on each node. Do not move to 
    the next node before validating the node that you upgraded is up and 
