...
This article will guide you through self-managed ScyllaDB Enterprise deployment on AWS. For a fully-managed deployment of ScyllaDB 
...
#. Tag your instance
#. Configure Security Group. Make sure all :ref:`ScyllaDB ports <networking-ports>` are open.
