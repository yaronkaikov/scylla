...
control_protocol::control_protocol(condition_variable& cv)
    : _sender_recent_dict(nullptr)
    , _sender_committed_dict(nullptr)
    , _sender_current_dict(nullptr)
    , _receiver_recent_dict(nullptr)
    , _receiver_committed_dict(nullptr)
    , _receiver_current_dict(nullptr)
    , _needs_progress(cv)
{
}
