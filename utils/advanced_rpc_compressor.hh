...
struct control_protocol {
    ...
    dict_ptr _sender_recent_dict;
    dict_ptr _sender_committed_dict;
    dict_ptr _sender_current_dict;
    dict_ptr _receiver_recent_dict;
    dict_ptr _receiver_committed_dict;
    dict_ptr _receiver_current_dict;
