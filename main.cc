...
// the ticket about migrating to libunwind: scylladb/seastar#1878
            ...
            cql3::query_processor::memory_config qp_mcfg = {get_available_memory() / 256, memory::stats().total_memory() / 2560};
          ...
          shared_token_metadata::mutate_on_all_shards(token_metadata, [host_id, endpoint = utils::fb_utilities::get_broadcast_address()] (locator::token_metadata& tm) {
            ...
            messaging.start(std::ref(sl_controller), std::ref(compressor_tracker), mscfg, scfg, creds, std::ref(feature_service)).get();
            ...
            ss.start(std::ref(stop_signal.as_sharded_abort_source()),
                ...
                std::ref(tablet_allocator), std::ref(cdc_generation_service), std::ref(sl_controller)).get();
