...
public:
    ...
    api::timestamp_type min_live_timestamp(const dht::decorated_key& dk, api::timestamp_type max_seen_timestamp) const noexcept;
...
public:
    ...
    future<> compact_all_sstables(std::optional<tasks::task_info> info = std::nullopt, do_flush = do_flush::yes, bool consider_only_existing_data = false);
